...
(function () {
  ...
  class HistoryController extends Controller {
    ...
    initDatePickers() {
      ...
      this.element.querySelectorAll('.input-group.date.datepicker').forEach((el) => {
        const $el = jQuery(el)
        if ($el.data('datepicker')) $el.datepicker('destroy')
        $el.datepicker().on('changeDate.historyFilter', () => this.apply())
      })
    }
  ...
  window.StimulusHistoryController = HistoryController
})()
