...
class Reports::Dashboards::VacanciesController < ApplicationController
  ...
  def set_report
    ...
    @report = Dashboards::Vacancies.new(start_date: @start_date, end_date: @end_date, match_route_name: @match_route_name, program_types: @program_types)
  end
end
