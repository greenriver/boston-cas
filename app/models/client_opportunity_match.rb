class ClientOpportunityMatch < ActiveRecord::Base
  ...
  has_decision :set_asides_hsa_acknowledges_receipt, decision_class_name: 'MatchDecisions::HomelessSetAside::HsaAcknowledgesReceipt', notification_class_name: 'Notifications::HomelessSetAside::MatchInitiationForHsa'
  has_decision :set_asides_hsa_accepts_client, decision_class_name: 'MatchDecisions::HomelessSetAside::HsaAcceptsClient', notification_class_name: 'Notifications::HomelessSetAside::HsaAcceptsClient'
  ...
  has_decision :set_asides_confirm_hsa_accepts_client_decline_dnd_staff, decision_class_name: 'MatchDecisions::HomelessSetAside::ConfirmHsaAcceptsClientDeclineDndStaff', notification_class_name: 'Notifications::ConfirmHousingSubsidyAdminDeclineDndStaff'
