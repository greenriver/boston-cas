    ...
    def form_fields
      {
        ...
        household_section: {
          ...
          questions: {
            ...
            current_living_situation: {
              ...
              collection: {
                Translation.translate('Emergency shelter in the City of Boston') => 'Emergency shelter in the City of Boston',
                Translation.translate('Outside/place not meant for human habitation within the City of Boston') => 'Outside/place not meant for human habitation within the City of Boston',
                Translation.translate('Transitional housing program in the City of Boston') => 'Transitional housing program in the City of Boston',
                Translation.translate('Currently fleeing violence while in your own home or doubled up with others and a Boston resident.') => 'Currently fleeing violence while in your own home or doubled up with others and a Boston resident.',
              },
              as: :pretty_boolean_group,
            },
          },
        ...
        housing_placement_section: {
          ...
          questions: {
            pending_housing_placement_type: {
              label: 'Unit type',
              collection: {
                Translation.translate('I have a voucher to find a unit (Section 8, Housing Choice Voucher, CAS, MRVP, other)') => 'I have a voucher to find a unit (Section 8, Housing Choice Voucher, CAS, MRVP, other)',
                Translation.translate('Public Housing unit') => 'Public Housing unit',
              },
              as: :pretty_boolean_group,
            },
        ...
        no_rrh_desired_section: {
          ...
          questions: {
            no_rrh_desired_reason: {
              label: 'RRH interest',
              collection: {
                Translation.translate('I have too little income and do not think I can increase it') => 'I have too little income and do not think I can increase it',
                Translation.translate('I want to wait for subsidized housing') => 'I want to wait for subsidized housing',
                Translation.translate('I’m undecided but may reconsider') => 'I’m undecided but may reconsider',
                Translation.translate('I don’t want to live in a single room') => 'I don’t want to live in a single room',
                Translation.translate('I don’t want to live in a roommate situation') => 'I don’t want to live in a roommate situation',
              },
              as: :pretty_boolean_group,
            },
        ...
        provider_agency_preference: {
          ...
          number: '5E',
          collection: {
            Translation.translate('RRH staff at 112 Southampton Street Shelter') => 'RRH staff at 112 Southampton Street Shelter',
            Translation.translate('RRH staff at Woods Mullen Shelter') => 'RRH staff at Woods Mullen Shelter',
            Translation.translate('RRH staff at Pine Street Inn') => 'RRH staff at Pine Street Inn',
            Translation.translate('RRH staff at HomeStart') => 'RRH staff at HomeStart',
            Translation.translate('RH Staff at Bridge Over Troubled Water (youth agency)') => 'RH Staff at Bridge Over Troubled Water (youth agency)',
            Translation.translate('RRH Staff at Casa Myrna Vazquez (domestic violence agency)') => 'RRH Staff at Casa Myrna Vazquez (domestic violence agency)',
            Translation.translate('RRH Staff at Elizabeth Stonehouse (domestic violence agency)') => 'RRH Staff at Elizabeth Stonehouse (domestic violence agency)',
            Translation.translate('No preference, any agency') => 'No preference, any agency',
          },
          as: :select_2,
