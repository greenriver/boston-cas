...
module RouteFourDecisions
  ...
  included do
    ...
    has_decision :four_confirm_schedule_criminal_hearing_decline_dnd_staff, decision_class_name: 'MatchDecisions::Four::ConfirmScheduleCriminalHearingDeclineDndStaff', notification_class_name: 'Notifications::Four::ConfirmScheduleCriminalHearingDeclineDndStaff'
    ...
    has_decision :four_confirm_record_client_housed_date_decline_dnd_staff, decision_class_name: 'MatchDecisions::Four::ConfirmRecordClientHousedDateDeclineDndStaff', notification_class_name: 'Notifications::Four::ConfirmRecordClientHousedDateDeclineDndStaff'
