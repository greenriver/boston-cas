  ...
  def expected_header
    {
      timestamp: 'Timestamp',
      email: 'Email Address',
      provider_ack: 'Provider Acknowldgement',
      housing_status: 'Household is currently:',
      days_homeless: 'Days Homeless',
      provider_ack_2: 'Provider Acknowledgement',
      ...
      signature: 'I (head of household) acknowledge the above statement by typing my name below.',
      ...
      voucher_agency: 'If you have a tenant-based housing choice voucher, what is the administering housing authority/agency?',
      children: 'What is the age and gender of each of the children in the household? (this information may be used by some housing providers to determine your priority for bedroom size needed )',
      ...
      interested_in_disabled_housing: 'Are you interested in applying for housing units targeted for persons with disabilities?',
