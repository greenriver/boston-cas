...
module MatchDecisions
  class ConfirmShelterDeclineOfHoused < Base
    ...
    def label_for_status status
      ...
      when :decline_overridden then "#{_('Shelter Agency')} Decline overridden by DND.  Match proceeding to #{_('DND')}"
      when :decline_overridden_returned then "#{_('Shelter Agency')} overridden by #{_('DND')}.  Match returned to #{_('Housing Subsidy Administrator')}"
