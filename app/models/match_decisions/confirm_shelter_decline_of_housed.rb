...
module MatchDecisions
  class ConfirmShelterDeclineOfHoused < Base
    def statuses
      {
        pending: 'Pending',
    ...
    def label_for_status status
      ...
      when :decline_overridden then "#{Translation.translate('Shelter Agency')} Decline overridden by DND.  Match proceeding to #{Translation.translate('DND')}"
      when :decline_overridden_returned then "#{Translation.translate('Shelter Agency')} overridden by #{Translation.translate('DND')}.  Match returned to #{Translation.translate('Housing Subsidy Administrator')}"
    ...
    class StatusCallbacks < StatusCallbacks
      ...
      def decline_overridden
        match.record_client_housed_date_housing_subsidy_administrator_decision.update(status: :skipped)
