  ...
  class RecordVoucherDateHousingSubsidyAdmin < ::MatchDecisions::Base
    ...
    def notifications_for_this_step
      @notifications_for_this_step ||= [].tap do |m|
        m << Notifications::Eight::RecordVoucherDateHousingSubsidyAdmin
        m << Notifications::Eight::MatchInProgressShelterAgency
      end
    end
    ...
    class StatusCallbacks < StatusCallbacks
      ...
      def declined
        ...
        match.eight_confirm_housing_subsidy_admin_decline_dnd_staff_decision.initialize_decision!
      end
