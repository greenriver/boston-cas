...
module MatchDecisions::Four
  class ConfirmScheduleCriminalHearingDeclineDndStaff < ::MatchDecisions::Base
    def statuses
      {
        pending: 'Pending',
    ...
    def label_for_status status
      ...
      when :decline_overridden then "#{Translation.translate('Housing Subsidy Administrator')} Decline overridden by #{Translation.translate('DND')}.  Match returned to #{Translation.translate('Housing Subsidy Administrator')}"
    ...
    def notifications_for_this_step
      @notifications_for_this_step ||= [].tap do |m|
        m << Notifications::Four::ConfirmScheduleCriminalHearingDeclineDndStaff
    ...
    def to_param
      :four_confirm_schedule_criminal_hearing_decline_dnd_staff
    end
