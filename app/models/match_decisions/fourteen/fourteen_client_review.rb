...
module MatchDecisions::Fourteen
  class FourteenClientReview < Base
    include MatchDecisions::AcceptsDeclineReason

    validate :ensure_required_contacts_present_on_accept

    def to_partial_path
      'match_decisions/fourteen/client_review'
    end
    ...
    def notifications_for_this_step
      @notifications_for_this_step ||= [].tap do |m|
        m << Notifications::Fourteen::FourteenClientReviewShelterAgency
        m << Notifications::Fourteen::FourteenClientReviewFyi
      end
    end
    ...
    class StatusCallbacks < StatusCallbacks
      ...
      def declined
        ...
        match.fourteen_client_review_decline_decision.initialize_decision!
      end
