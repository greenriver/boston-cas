...
module MatchDecisions::Fourteen
  class FourteenClientReviewDecline < Base
    include MatchDecisions::AcceptsDeclineReason

    def to_partial_path
      'match_decisions/fourteen/client_review_decline'
    end
    ...
    def notifications_for_this_step
      @notifications_for_this_step ||= [].tap do |m|
        m << Notifications::Fourteen::FourteenClientReviewDecline
      end
    end
    ...
    def label_for_status status
      ...
      when :decline_overridden then "#{Translation.translate('Shelter Agency Fourteen')} Decline overridden by #{Translation.translate('CoC Fourteen')}.  Match proceeding to #{Translation.translate('Housing Search Provider Fourteen')}"
    ...
    class StatusCallbacks < StatusCallbacks
      ...
      def decline_overridden
        match.fourteen_client_review_decision.update(status: :skipped)
