...
module MatchDecisions::Fourteen
  class FourteenEligibilityScreening < Base
    include MatchDecisions::AcceptsDeclineReason

    validate :ensure_required_contacts_present_on_accept

    def to_partial_path
      'match_decisions/fourteen/eligibility_screening'
    end
    ...
    def notifications_for_this_step
      @notifications_for_this_step ||= [].tap do |m|
        m << Notifications::Fourteen::FourteenEligibilityScreeningHsp
        m << Notifications::Fourteen::FourteenEligibilityScreeningFyi
      end
    end
