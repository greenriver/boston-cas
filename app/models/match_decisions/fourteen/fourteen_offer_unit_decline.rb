...
module MatchDecisions::Fourteen
  class FourteenOfferUnitDecline < Base
    include MatchDecisions::AcceptsDeclineReason

    def to_partial_path
      'match_decisions/fourteen/offer_unit_decline'
    end
    ...
    def notifications_for_this_step
      @notifications_for_this_step ||= [].tap do |m|
        m << Notifications::Fourteen::FourteenOfferUnitDecline
      end
    end
    ...
    class StatusCallbacks < StatusCallbacks
      ...
      def decline_overridden
        match.fourteen_offer_unit_decision.update(status: :skipped)
        match.fourteen_confirm_match_success_decision.initialize_decision!
      end
