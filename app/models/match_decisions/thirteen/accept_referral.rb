...
module MatchDecisions::Thirteen
  class AcceptReferral < ::MatchDecisions::Base
    ...
    def notifications_for_this_step
      @notifications_for_this_step ||= [].tap do |m|
        m << Notifications::Thirteen::AcceptReferralShelterAgency
        m << Notifications::Thirteen::AcceptReferralHsa
        m << Notifications::Thirteen::AcceptReferralSsp
        m << Notifications::Thirteen::AcceptReferralHsp
      end
    end
