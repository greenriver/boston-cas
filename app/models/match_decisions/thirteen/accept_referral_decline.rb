...
module MatchDecisions::Thirteen
  class AcceptReferralDecline < ::MatchDecisions::Base
    ...
    def step_name
      "#{Translation.translate('CoC Thirteen')} Accept Referral Decline"
    end
    ...
    def notifications_for_this_step
      @notifications_for_this_step ||= [].tap do |m|
        m << Notifications::Thirteen::AcceptReferralDecline
      end
    end
    ...
    class StatusCallbacks < StatusCallbacks
      ...
      def decline_overridden
        match.thirteen_accept_referral_decision.update(status: :skipped)
        match.thirteen_confirm_match_success_decision.initialize_decision!
      end

      def decline_overridden_returned
        # Re-initialize the previous decision
        match.thirteen_accept_referral_decision.initialize_decision!
