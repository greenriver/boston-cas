...
module MatchDecisions::Thirteen
  class ClientReview < ::MatchDecisions::Base
    ...
    def notifications_for_this_step
      @notifications_for_this_step ||= [].tap do |m|
        m << Notifications::Thirteen::ClientReviewShelterAgency
        m << Notifications::Thirteen::ClientReviewHsa
        m << Notifications::Thirteen::ClientReviewDndStaff
      end
    end
