...
module MatchDecisions::Thirteen
  class ConfirmMatchSuccess < ::MatchDecisions::Base
    ...
    def notifications_for_this_step
      @notifications_for_this_step ||= [].tap do |m|
        m << Notifications::Thirteen::ConfirmMatchSuccessHsa
        m << Notifications::Thirteen::ConfirmMatchSuccessShelterAgency
        m << Notifications::Thirteen::ConfirmMatchSuccessDndStaff
      end
    end
