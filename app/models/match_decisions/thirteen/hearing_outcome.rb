...
module MatchDecisions::Thirteen
  class HearingOutcome < ::MatchDecisions::Base
    ...
    def notifications_for_this_step
      @notifications_for_this_step ||= [].tap do |m|
        m << Notifications::Thirteen::HearingOutcomeShelterAgency
        m << Notifications::Thirteen::HearingOutcomeHsa
        m << Notifications::Thirteen::HearingOutcomeDndStaff
      end
    end
