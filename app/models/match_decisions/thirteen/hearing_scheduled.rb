...
module MatchDecisions::Thirteen
  class HearingScheduled < ::MatchDecisions::Base
    ...
    def notifications_for_this_step
      @notifications_for_this_step ||= [].tap do |m|
        m << Notifications::Thirteen::HearingScheduledShelterAgency
        m << Notifications::Thirteen::HearingScheduledHsa
        m << Notifications::Thirteen::HearingScheduledDndStaff
      end
    end
