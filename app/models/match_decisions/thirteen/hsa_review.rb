...
module MatchDecisions::Thirteen
  class HsaReview < ::MatchDecisions::Base
    ...
    def notifications_for_this_step
      @notifications_for_this_step ||= [].tap do |m|
        m << Notifications::Thirteen::HsaReviewShelterAgency
        m << Notifications::Thirteen::HsaReviewHsa
        m << Notifications::Thirteen::HsaReviewDndStaff
      end
    end
