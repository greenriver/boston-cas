...
module MatchDecisions::Thirteen
  class ThirteenHsaReviewDecline < ::MatchDecisions::Base
    ...
    def step_name
      "#{Translation.translate('CoC Thirteen')} HSA Review Decline"
    end
    ...
    def notifications_for_this_step
      @notifications_for_this_step ||= [].tap do |m|
        m << Notifications::Thirteen::ThirteenHsaReviewDecline
      end
    end
    ...
    class StatusCallbacks < StatusCallbacks
      ...
      def decline_overridden
        match.thirteen_hsa_review_decision.update(status: :skipped)
