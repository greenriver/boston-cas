...
class StalledResponse < ApplicationRecord
  ...
  def self.all_responses
    [
      ...
      {
        client_engaging: false,
        reason: 'The client has been temporarily institutionalized/incarcerated',
        steps: [
          'MatchDecisions::Thirteen::ThirteenAcceptReferral',
          'MatchDecisions::Thirteen::ThirteenHearingOutcome',
          'MatchDecisions::Thirteen::ThirteenHearingScheduled',
      ...
      {
        client_engaging: true,
        reason: 'Waiting on Birth certificate',
        steps: [
          'MatchDecisions::Thirteen::ThirteenAcceptReferral',
          'MatchDecisions::Thirteen::ThirteenHearingOutcome',
          'MatchDecisions::Thirteen::ThirteenHearingScheduled',
      ...
      {
        client_engaging: true,
        reason: 'Waiting on SSI/SSDI card',
        steps: [
          'MatchDecisions::Thirteen::ThirteenAcceptReferral',
          'MatchDecisions::Thirteen::ThirteenHearingOutcome',
          'MatchDecisions::Thirteen::ThirteenHearingScheduled',
      ...
      {
        client_engaging: true,
        reason: 'Waiting for response from partner agency',
        steps: [
          'MatchDecisions::Thirteen::ThirteenAcceptReferral',
          'MatchDecisions::Thirteen::ThirteenHearingOutcome',
          'MatchDecisions::Thirteen::ThirteenHearingScheduled',
