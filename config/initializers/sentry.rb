...
# Hence, we use CAS_SENTRY_DSN. Any other alternate key should also be fine.
if ENV['CAS_SENTRY_DSN'].present?
  Sentry.init do |config|
    config.dsn = ENV['CAS_SENTRY_DSN']
    ...
    event_filter = SentryEventFilter.new(Rails.application.config.filter_parameters)
