...
SimpleForm.setup do |config|
  ...
  config.wrappers :vertical_form_hint_first, tag: 'div', class: 'form-group', error_class: 'error' do |b|
    ...
    b.wrapper tag: 'div', class: 'controls' do |ba|
      ba.wrapper tag: 'div', class: 'form--label-hint-wrapper' do |bb|
        bb.wrapper tag: 'div', class: 'form--label-hint' do |bc|
          bc.use :label, class: 'control-label'
  ...
  config.wrappers :multi_select, tag: 'div', class: 'form-group', error_class: 'has-error' do |b|
    ...
    b.optional :readonly
    b.use :label, class: 'control-label'
    b.wrapper tag: 'div', class: 'd-flex flex-wrap align-items-center gap-2' do |ba|
      ba.use :input, class: 'form-control'
      ba.use :error, wrap_with: { tag: 'span', class: 'help-block' }
      ba.use :hint,  wrap_with: { tag: 'p', class: 'help-block' }
    end
