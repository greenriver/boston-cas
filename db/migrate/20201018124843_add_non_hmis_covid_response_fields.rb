class AddNonHmisCovidResponseFields < ActiveRecord::Migration[6.0]
  def change
    ...
    add_column :non_hmis_assessments, :ssn, :string
    add_column :non_hmis_assessments, :ssn_refused, :boolean, default: false
    ...
    add_column :non_hmis_assessments, :high_covid_risk, :string
    ...
    add_column :non_hmis_assessments, :intensive_needs, :string
