...
CREATE TABLE clients (
    ...
    income_information_date date,
    income_from_any_source character varying(20),
    income_total_montly integer,
    income_earned boolean,
    income_unimployment boolean,
    income_ssi boolean,
    income_va_service boolean,
    income_va_non_service boolean,
    income_private_disability boolean,
    income_workers_comp boolean,
    income_tnaf boolean,
    income_general_assistance boolean,
    income_ss_retirement boolean,
    income_pension boolean,
    income_child_support boolean,
    income_spousal_support boolean,
    income_other boolean,
    income_other_sources character varying,
    income_earned_monthly integer,
    income_unimployment_monthly integer,
    income_ssi_monthly integer,
    income_va_service_monthly integer,
    income_va_non_service_monthly integer,
    income_private_disability_monthly integer,
    income_workers_comp_monthly integer,
    income_tnaf_monthly integer,
    income_general_assistance_monthly integer,
    income_ss_retirement_monthly integer,
    income_pension_monthly integer,
    income_child_support_monthly integer,
    income_spousal_support_monthly integer,
    income_other_monthly integer,
    income_total_monthly integer,
    non_cash_benefits_information_date date,
    non_cash_benefits character varying(20),
    snap boolean,
    wic boolean,
    tnaf_child_care boolean,
    tnaf_transportaion boolean,
    tnaf_other_benefit boolean,
    ongoing_rental_assistance boolean,
    other_benefit_sources boolean,
    temporary_rental_assistance boolean,
    health_insurance_information_date date,
    health_insurance character varying(4),
    health_insurance_medicaid boolean,
    health_insurance_medicaid_reason character varying(4),
    health_insurance_medicare boolean,
    health_insurance_medicare_reason character varying(4),
    health_insurance_state_childrens boolean,
    health_insurance_state_childrens_reason character varying(4),
    health_insurance_va boolean,
    health_insurance_va_reason character varying(4),
    health_insurance_employer boolean,
    health_insurance_employer_reason character varying(4),
    health_insurance_cobra boolean,
    health_insurance_cobra_reason character varying(4),
    health_insurance_private_pay boolean,
    health_insurance_private_pay_reason character varying(4),
    health_insurance_state_adults boolean,
    health_insurance_state_adults_reason character varying(4),
    created_at timestamp without time zone NOT NULL,
    updated_at timestamp without time zone NOT NULL,
    deleted_at timestamp without time zone,
    merged_into integer,
...
CREATE TABLE project_clients (
    ...
    on_parole boolean,
    on_parole_end_date date,
    on_probation boolean,
    on_probation_end_date date,
    meth_production_conviction boolean,
    id_in_data_source integer,
    calculated_bed_nights_in_last_three_years integer,
    calculated_episodes_in_last_three_years integer,
    calculated_months_continously_homeless_in_last_three_years integer,
    calculated_first_homeless_night date,
    reported_episodes_in_last_three_years character varying,
    reported_continuously_homeless_for_last_year character varying,
    reported_months_homeless_in_last_three_years character varying,
    reported_months_continuously_homeless_immediately_prior character varying,
    reported_months_continuously_homeless_documented character varying,
    project_exit_destination character varying,
    project_exit_destination_specific character varying,
    project_exit_destination_generic character varying,
    project_exit_housing_disposition character varying,
    calculated_last_homeless_night date,
    source_last_changed timestamp without time zone,
    last_homeless_night_programid integer,
    last_homeless_night_roomid integer,
    data_source_id integer,
    data_source_id_column_name character varying,
    client_id integer,
    homephone character varying,
...
--
-- Name: index_users_on_housing_subsidy_admin; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX index_users_on_housing_subsidy_admin ON users USING btree (housing_subsidy_admin);
