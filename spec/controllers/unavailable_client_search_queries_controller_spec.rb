...
RSpec.describe UnavailableClientSearchQueriesController, type: :controller do
  ...
  describe 'GET #show' do
    ...
    it 'redirects to new search query when different search term is provided' do
      ...
      expect(response).to redirect_to(/unavailable_client_search_queries\/[\w-]+/)
      redirected_id = response.location.match(/unavailable_client_search_queries\/([\w-]+)/)[1]
