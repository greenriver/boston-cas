...
RSpec.describe Rules::AgeGreaterThanFifty, type: :model do
  describe 'clients_that_fit' do

    let!(:rule) { create :age_greater_than_fifty }

    let!(:bob) { create :client, first_name: 'Bob', date_of_birth: Date.current - 49.years }
    let!(:roy) { create :client, first_name: 'Roy',  date_of_birth: Date.current - 50.years }
    let!(:mary) { create :client, first_name: 'Mary',  date_of_birth: Date.current - 51.years }
    ...
    context 'when positive' do
      ...
      it 'does not contain Bob (49 y.o.)' do
    ...
    context 'when negative' do
      ...
      it 'does not contain Mary (51 y.o)' do
