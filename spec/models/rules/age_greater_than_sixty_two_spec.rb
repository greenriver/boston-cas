...
RSpec.describe Rules::AgeGreaterThanSixtyTwo, type: :model do
  describe 'clients_that_fit' do

    let!(:rule) { create :age_greater_than_sixty_two }

    let!(:bob) { create :client, first_name: 'Bob', date_of_birth: Date.current - 61.years }
    let!(:roy) { create :client, first_name: 'Roy',  date_of_birth: Date.current - 62.years }
    let!(:mary) { create :client, first_name: 'Mary',  date_of_birth: Date.current - 63.years }
    ...
    context 'when positive' do
      ...
      it 'does not contain Bob (61 y.o.)' do
    ...
    context 'when negative' do
      ...
      it 'does not contain Mary (63 y.o)' do
