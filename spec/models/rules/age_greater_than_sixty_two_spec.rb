...
RSpec.describe Rules::AgeGreaterThanSixtyTwo, type: :model do
  describe 'clients_that_fit' do
    ...
    let!(:bob) { create :client, first_name: 'Bob', date_of_birth: Date.today - 61.years }
    let!(:roy) { create :client, first_name: 'Roy',  date_of_birth: Date.today - 62.years }
    let!(:mary) { create :client, first_name: 'Mary',  date_of_birth: Date.today - 63.years }
