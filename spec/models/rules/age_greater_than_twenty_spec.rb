...
RSpec.describe Rules::AgeGreaterThanTwenty, type: :model do
  describe 'clients_that_fit' do
    let!(:rule) { create :twenty_plus }

    let!(:bob) { create :client, first_name: 'Bob', date_of_birth: Date.current - 19.years }
    let!(:roy) { create :client, first_name: 'Roy', date_of_birth: Date.current - 20.years }
    let!(:mary) { create :client, first_name: 'Mary', date_of_birth: Date.current - 21.years }
    ...
    context 'when positive' do
      ...
      it 'does not contain Bob (19 y.o.)' do
