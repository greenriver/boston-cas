...
RSpec.describe Rules::AgeGreaterThanY, type: :model do
  describe 'clients_that_fit' do
    let!(:rule) { create :age_greater_than_y }
    ...
    let!(:positive) { create :requirement, rule: rule, positive: true, variable: 21 }
    let!(:negative) { create :requirement, rule: rule, positive: false, variable: 21 }
