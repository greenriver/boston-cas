...
RSpec.describe Rules::AidsOrRelatedDiseases, type: :model do
  describe 'clients_that_fit' do

    let!(:rule) { create :aids_or_related_diseases }

    let!(:bob) { create :client, first_name: 'Bob', hiv_aids: false, hiv_positive: false }
    let!(:roy) { create :client, first_name: 'Roy',  hiv_aids: false, hiv_positive: true }
    let!(:mary) { create :client, first_name: 'Mary',  hiv_aids: true, hiv_positive: false }
    let!(:sue) { create :client, first_name: 'Sue', hiv_aids: true, hiv_positive: true  }
