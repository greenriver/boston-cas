...
RSpec.describe Rules::AppropriateForSoberSupportiveHousing, type: :model do
  describe 'clients_that_fit' do
    let!(:rule) { create :appropriate_for_sober_supportive_housing }

    let!(:bob) { create :client, first_name: 'Bob', sober_housing: true }
    let!(:roy) { create :client, first_name: 'Roy', sober_housing: false }
