...
RSpec.describe Rules::Asylee, type: :model do
  describe 'clients_that_fit' do
    let!(:rule) { create :asylee }

    let!(:bob) { create :client, first_name: 'Bob', asylee: true }
    let!(:roy) { create :client, first_name: 'Roy', asylee: false }
