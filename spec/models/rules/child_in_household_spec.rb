...
RSpec.describe Rules::ChildInHousehold, type: :model do
  describe 'clients_that_fit' do
    let!(:rule) { create :child_in_household }

    let!(:bob) { create :client, first_name: 'Bob', child_in_household: true }
    let!(:roy) { create :client, first_name: 'Roy', child_in_household: false }
