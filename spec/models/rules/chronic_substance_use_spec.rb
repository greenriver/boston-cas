...
RSpec.describe Rules::ChronicSubstanceUse, type: :model do
  describe 'clients_that_fit' do
    let!(:rule) { create :chronic_substance_use }

    let!(:bob) { create :client, first_name: 'Bob', substance_abuse_problem: true }
    let!(:roy) { create :client, first_name: 'Roy', substance_abuse_problem: false }
