...
RSpec.describe Rules::ChronicallyHomeless, type: :model do
  describe 'clients_that_fit' do
    let!(:rule) { create :chronically_homeless }

    let!(:bob) { create :client, first_name: 'Bob', chronic_homeless: true }
    let!(:roy) { create :client, first_name: 'Roy', chronic_homeless: false }
