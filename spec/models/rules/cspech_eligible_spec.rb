...
RSpec.describe Rules::CspechEligible, type: :model do
  describe 'clients_that_fit' do
    let!(:rule) { create :cspech_eligible }

    let!(:bob) { create :client, first_name: 'Bob', cspech_eligible: true }
    let!(:roy) { create :client, first_name: 'Roy', cspech_eligible: false }
