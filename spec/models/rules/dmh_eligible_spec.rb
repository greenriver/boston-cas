...
RSpec.describe Rules::DmhEligible, type: :model do
  describe 'clients_that_fit' do
    let!(:rule) { create :dmh_eligible }

    let!(:bob) { create :client, first_name: 'Bob', dmh_eligible: true }
    let!(:roy) { create :client, first_name: 'Roy', dmh_eligible: false }
