...
RSpec.describe Rules::EnrolledInEs, type: :model do
  describe 'clients_that_fit' do
    let!(:rule) { create :enrolled_in_es }

    let!(:bob) { create :client, first_name: 'Bob', enrolled_in_es: true }
    let!(:roy) { create :client, first_name: 'Roy', enrolled_in_es: false }
