...
RSpec.describe Rules::EnrolledInHmisProjectType, type: :model do
  describe 'clients_that_fit' do
    let!(:rule) { create :enrolled_in_hmis_project_type }

    let!(:bob) { create :client, first_name: 'Bob', enrolled_in_es: false, enrolled_in_ph: false, enrolled_in_psh: false }
    let!(:roy) { create :client, first_name: 'Roy', enrolled_in_es: true, enrolled_in_ph: true, enrolled_in_psh: false }
    let!(:mary) { create :client, first_name: 'Mary', enrolled_in_es: false, enrolled_in_ph: false, enrolled_in_psh: true }
    let!(:sue) { create :client, first_name: 'Sue', enrolled_in_es: true, enrolled_in_ph: false, enrolled_in_psh: true }
    let!(:zelda) { create :client, first_name: 'Zelda', enrolled_in_es: true, enrolled_in_ph: true, enrolled_in_psh: true }
