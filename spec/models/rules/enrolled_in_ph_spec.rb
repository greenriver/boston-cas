...
RSpec.describe Rules::EnrolledInPh, type: :model do
  describe 'clients_that_fit' do
    let!(:rule) { create :enrolled_in_ph }

    let!(:bob) { create :client, first_name: 'Bob', enrolled_in_ph: true }
    let!(:roy) { create :client, first_name: 'Roy', enrolled_in_ph: false }
