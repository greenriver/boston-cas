...
RSpec.describe Rules::EnrolledInRrhNoMoveIn, type: :model do
  describe 'clients_that_fit' do
    let!(:rule) { create :enrolled_in_rrh_pre_move_in }

    let!(:bob) { create :client, first_name: 'Bob', enrolled_in_rrh_pre_move_in: true }
    let!(:roy) { create :client, first_name: 'Roy', enrolled_in_rrh_pre_move_in: false }
