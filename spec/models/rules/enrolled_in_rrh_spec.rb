...
RSpec.describe Rules::EnrolledInRrh, type: :model do
  describe 'clients_that_fit' do
    let!(:rule) { create :enrolled_in_rrh }

    let!(:bob) { create :client, first_name: 'Bob', enrolled_in_rrh: true }
    let!(:roy) { create :client, first_name: 'Roy', enrolled_in_rrh: false }
