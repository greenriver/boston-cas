...
RSpec.describe Rules::EnrolledInSh, type: :model do
  describe 'clients_that_fit' do
    let!(:rule) { create :enrolled_in_sh }

    let!(:bob) { create :client, first_name: 'Bob', enrolled_in_sh: true }
    let!(:roy) { create :client, first_name: 'Roy', enrolled_in_sh: false }
