...
RSpec.describe Rules::EnrolledInSo, type: :model do
  describe 'clients_that_fit' do
    let!(:rule) { create :enrolled_in_so }

    let!(:bob) { create :client, first_name: 'Bob', enrolled_in_so: true }
    let!(:roy) { create :client, first_name: 'Roy', enrolled_in_so: false }
