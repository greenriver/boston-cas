...
RSpec.describe Rules::EnrolledInTh, type: :model do
  describe 'clients_that_fit' do
    let!(:rule) { create :enrolled_in_th }

    let!(:bob) { create :client, first_name: 'Bob', enrolled_in_th: true }
    let!(:roy) { create :client, first_name: 'Roy', enrolled_in_th: false }
