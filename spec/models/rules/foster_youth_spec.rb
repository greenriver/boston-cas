...
RSpec.describe Rules::FosterYouth, type: :model do
  describe 'clients_that_fit' do
    let!(:rule) { create :foster_youth }

    let!(:bob) { create :client, first_name: 'Bob', foster_care: true }
    let!(:roy) { create :client, first_name: 'Roy', foster_care: false }
