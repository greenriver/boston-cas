...
RSpec.describe Rules::HealthPrioritized, type: :model do
  describe 'clients_that_fit' do
    let!(:rule) { create :health_prioritized }

    let!(:bob) { create :client, first_name: 'Bob', health_prioritized: true }
    let!(:roy) { create :client, first_name: 'Roy', health_prioritized: false }
