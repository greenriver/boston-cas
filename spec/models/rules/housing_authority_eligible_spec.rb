...
RSpec.describe Rules::HousingAuthorityEligible, type: :model do
  describe 'clients_that_fit' do
    let!(:rule) { create :housing_authority_eligible }

    let!(:bob) { create :client, first_name: 'Bob', ha_eligible: true }
    let!(:roy) { create :client, first_name: 'Roy', ha_eligible: false }
