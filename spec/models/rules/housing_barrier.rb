...
RSpec.describe Rules::HousingBarrier, type: :model do
  describe 'clients_that_fit' do
    let!(:rule) { create :housing_barrier }

    let!(:bob) { create :client, first_name: 'Bob', housing_barrier: true }
    let!(:roy) { create :client, first_name: 'Roy', housing_barrier: false }
