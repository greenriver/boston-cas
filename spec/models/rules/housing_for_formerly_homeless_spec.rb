...
RSpec.describe Rules::HousingForFormerlyHomeless, type: :model do
  describe 'clients_that_fit' do
    let!(:rule) { create :housing_for_formerly_homeless }

    let!(:bob) { create :client, first_name: 'Bob', housing_for_formerly_homeless: true }
    let!(:roy) { create :client, first_name: 'Roy', housing_for_formerly_homeless: false }
