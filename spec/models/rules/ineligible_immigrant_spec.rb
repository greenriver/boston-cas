...
RSpec.describe Rules::IneligibleImmigrant, type: :model do
  describe 'clients_that_fit' do
    let!(:rule) { create :ineligible_immigrant }

    let!(:bob) { create :client, first_name: 'Bob', ineligible_immigrant: true }
    let!(:roy) { create :client, first_name: 'Roy', ineligible_immigrant: false }
