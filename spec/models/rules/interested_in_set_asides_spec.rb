...
RSpec.describe Rules::InterestedInSetAsides, type: :model do

  let!(:rule) { create :interested_in_set_asides }

  let!(:bob) { create :client, first_name: 'Bob', interested_in_set_asides: true }
  let!(:roy) { create :client, first_name: 'Roy', interested_in_set_asides: false }
