...
RSpec.describe Rules::LifetimeSexOffender, type: :model do
  describe 'clients_that_fit' do
    let!(:rule) { create :lifetime_sex_offender }

    let!(:bob) { create :client, first_name: 'Bob', lifetime_sex_offender: true }
    let!(:roy) { create :client, first_name: 'Roy', lifetime_sex_offender: false }
