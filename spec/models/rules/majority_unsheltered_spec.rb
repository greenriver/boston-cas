...
RSpec.describe Rules::MajorityUnsheltered, type: :model do
  describe 'clients_that_fit' do
    let!(:rule) { create :majority_unsheltered }

    let!(:bob) { create :client, first_name: 'Bob', majority_sheltered: false }
    let!(:roy) { create :client, first_name: 'Roy', majority_sheltered: true }
