...
RSpec.describe Rules::MentalHealthEligible, type: :model do
  describe 'clients_that_fit' do
    let!(:rule) { create :mental_health_eligible }

    let!(:bob) { create :client, first_name: 'Bob', mental_health_problem: true }
    let!(:roy) { create :client, first_name: 'Roy', mental_health_problem: false }
