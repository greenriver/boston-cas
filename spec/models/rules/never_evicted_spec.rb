...
RSpec.describe Rules::NeverEvicted, type: :model do
  describe 'clients_that_fit' do
    let!(:rule) { create :evicted }

    let!(:roy) { create :client, first_name: 'Bob', evicted: true }
    let!(:bob) { create :client, first_name: 'Roy', evicted: false }
