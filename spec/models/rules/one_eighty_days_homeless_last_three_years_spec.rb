...
RSpec.describe Rules::OneEightyDaysHomelessLastThreeYears, type: :model do
  describe 'clients_that_fit' do
    let!(:rule) { create :one_eighty_days_homeless_last_three_years }

    let!(:bob) { create :client, first_name: 'Bob', days_homeless_in_last_three_years: 179 }
    let!(:roy) { create :client, first_name: 'Roy', days_homeless_in_last_three_years: 180 }
    let!(:sue) { create :client, first_name: 'Sue', days_homeless_in_last_three_years: 181 }
