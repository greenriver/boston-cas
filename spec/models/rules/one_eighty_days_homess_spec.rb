...
RSpec.describe Rules::OneEightyDaysHomeless, type: :model do
  describe 'clients_that_fit' do
    let!(:rule) { create :one_eighty_days_homeless }

    let!(:bob) { create :client, first_name: 'Bob', days_homeless: 179 }
    let!(:roy) { create :client, first_name: 'Roy', days_homeless: 180 }
    let!(:sue) { create :client, first_name: 'Sue', days_homeless: 181 }
