...
RSpec.describe Rules::OneYearHomelessLastThreeYears, type: :model do
  describe 'clients_that_fit' do
    let!(:rule) { create :one_year_homeless_last_three_years }

    let!(:bob) { create :client, first_name: 'Bob', days_homeless_in_last_three_years: 364 }
    let!(:roy) { create :client, first_name: 'Roy', days_homeless_in_last_three_years: 365 }
    let!(:sue) { create :client, first_name: 'Sue', days_homeless_in_last_three_years: 366 }
