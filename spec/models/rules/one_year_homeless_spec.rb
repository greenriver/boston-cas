...
RSpec.describe Rules::OneYearHomeless, type: :model do
  describe 'clients_that_fit' do
    let!(:rule) { create :one_year_homeless }

    let!(:bob) { create :client, first_name: 'Bob', days_homeless: 364 }
    let!(:roy) { create :client, first_name: 'Roy', days_homeless: 365 }
    let!(:sue) { create :client, first_name: 'Sue', days_homeless: 366 }
