...
RSpec.describe Rules::OpenCase, type: :model do
  describe 'clients_that_fit' do
    let!(:rule) { create :open_case }

    let!(:bob) { create :client, first_name: 'Bob', open_case: true }
    let!(:roy) { create :client, first_name: 'Roy', open_case: false }
