...
RSpec.describe Rules::PartOfAFamily, type: :model do
  describe 'clients_that_fit' do
    let!(:rule) { create :part_of_a_family }

    let!(:bob) { create :client, first_name: 'Bob', family_member: true }
    let!(:roy) { create :client, first_name: 'Roy', family_member: false }
