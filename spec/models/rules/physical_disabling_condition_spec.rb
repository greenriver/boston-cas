...
RSpec.describe Rules::PhysicalDisablingCondition, type: :model do
  describe 'clients_that_fit' do
    let!(:rule) { create :physical_disability }

    let!(:bob) { create :client, first_name: 'Bob', physical_disability: true }
    let!(:roy) { create :client, first_name: 'Roy', physical_disability: false }
