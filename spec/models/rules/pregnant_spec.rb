...
RSpec.describe Rules::Pregnant, type: :model do
  describe 'clients_that_fit' do
    let!(:rule) { create :pregnant }

    let!(:bob) { create :client, first_name: 'Bob', pregnancy_status: true }
    let!(:roy) { create :client, first_name: 'Roy', pregnancy_status: false }
