...
RSpec.describe Rules::PregnantUnder28Weeks, type: :model do
  describe 'clients_that_fit' do
    let!(:rule) { create :pregnant_under_28_weeks }

    let!(:bob) { create :client, first_name: 'Bob', pregnant_under_28_weeks: true }
    let!(:roy) { create :client, first_name: 'Roy', pregnant_under_28_weeks: false }
