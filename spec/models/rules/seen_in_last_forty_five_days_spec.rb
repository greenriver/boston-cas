...
RSpec.describe Rules::SeenInLastFortyFiveDays, type: :model do
  describe 'clients_that_fit' do
    ...
    let!(:bob) { create :client, first_name: 'Bob', calculated_last_homeless_night: 44.days.ago.to_date }
    let!(:roy) { create :client, first_name: 'Roy', calculated_last_homeless_night: 46.days.ago.to_date }
