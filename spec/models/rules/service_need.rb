...
RSpec.describe Rules::ServiceNeed, type: :model do
  describe 'clients_that_fit' do
    let!(:rule) { create :service_need }

    let!(:bob) { create :client, first_name: 'Bob', service_need: true }
    let!(:roy) { create :client, first_name: 'Roy', service_need: false }
