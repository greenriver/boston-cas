...
RSpec.describe Rules::SroOk, type: :model do
  describe 'clients_that_fit' do
    let!(:rule) { create :sro_ok }

    let!(:bob) { create :client, first_name: 'Bob', sro_ok: true }
    let!(:roy) { create :client, first_name: 'Roy', sro_ok: false }
