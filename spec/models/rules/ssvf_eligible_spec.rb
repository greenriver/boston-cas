...
RSpec.describe Rules::SsvfEligible, type: :model do
  describe 'clients_that_fit' do
    let!(:rule) { create :ssvf_eligible }

    let!(:bob) { create :client, first_name: 'Bob', ssvf_eligible: true }
    let!(:roy) { create :client, first_name: 'Roy', ssvf_eligible: false }
