...
RSpec.describe Rules::TwoSeventyDaysHomeless, type: :model do
  describe 'clients_that_fit' do
    let!(:rule) { create :two_seventy_days_homeless }

    let!(:bob) { create :client, first_name: 'Bob', days_homeless: 269 }
    let!(:roy) { create :client, first_name: 'Roy', days_homeless: 270 }
    let!(:sue) { create :client, first_name: 'Sue', days_homeless: 271 }
