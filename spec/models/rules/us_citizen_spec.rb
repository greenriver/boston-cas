...
RSpec.describe Rules::UsCitizen, type: :model do
  describe 'clients_that_fit' do
    let!(:rule) { create :us_citizen }

    let!(:bob) { create :client, first_name: 'Bob', us_citizen: true }
    let!(:roy) { create :client, first_name: 'Roy', us_citizen: false }
