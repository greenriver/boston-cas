...
RSpec.describe Rules::VaEligible, type: :model do
  describe 'clients_that_fit' do
    let!(:rule) { create :va_eligible }

    let!(:bob) { create :client, first_name: 'Bob', va_eligible: true }
    let!(:roy) { create :client, first_name: 'Roy', va_eligible: false }
