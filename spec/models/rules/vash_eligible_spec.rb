...
RSpec.describe Rules::VashEligible, type: :model do
  describe 'clients_that_fit' do
    let!(:rule) { create :vash_eligible }

    let!(:bob) { create :client, first_name: 'Bob', vash_eligible: true }
    let!(:roy) { create :client, first_name: 'Roy', vash_eligible: false }
