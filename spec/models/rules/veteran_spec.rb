...
RSpec.describe Rules::Veteran, type: :model do
  describe 'clients_that_fit' do
    let!(:rule) { create :veteran }

    let!(:bob) { create :client, first_name: 'Bob', veteran: true }
    let!(:roy) { create :client, first_name: 'Roy', veteran: false }
