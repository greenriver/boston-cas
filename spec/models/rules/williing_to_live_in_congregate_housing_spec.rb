...
RSpec.describe Rules::WillingToLiveInCongregateHousing, type: :model do
  describe 'clients_that_fit' do
    let!(:rule) { create :willing_to_live_in_congregate_housing }

    let!(:bob) { create :client, first_name: 'Bob', congregate_housing: true }
    let!(:roy) { create :client, first_name: 'Roy', congregate_housing: false }
